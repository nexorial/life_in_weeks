...
const marketingLines = {
  ...
  "Alexandria Ocasio-Cortez": "Progressive insurgent who turned congressional hearings into viral policy theater.",
  "Robert F. Kennedy Jr.": "Dynastic environmental lawyer turned health politician, polarizing wellness politics.",
  "Pope Leo XIV": "Chicago-born Augustinian pope balancing Vatican continuity with American novelty.",
  "MrBeast": "YouTube's scale maximalist, converting spectacle, giveaways, and snacks into empire.",
  "Kai Cenat": "Livestream ringleader turning marathon chaos and celebrity drop-ins into culture.",
  "IShowSpeed": "Global IRL firestarter who made fandom, travel, and shouting portable.",
  "xQc": "Ex-Overwatch pro who turned restless variety streaming into perpetual motion.",
  "Adin Ross": "Provocative livestream host built on celebrity access and controversy cycles.",
  "Hasan Piker": "Left-wing Twitch commentator making politics feel like all-day reaction content.",
  "Pokimane": "Gaming's steady mainstreamer, blending streamer intimacy with creator-business discipline.",
  "Ninja": "Fortnite's breakout ambassador who dragged livestreaming into prime-time celebrity.",
  "Jynxzi": "Rainbow Six specialist who revived tactical shooters for the clip era.",
  "CaseOh": "Variety-stream comic turning self-aware banter into appointment-viewing comfort chaos.",
  "Markiplier": "Let's Play veteran pushing creator-led horror from uploads toward cinema.",
  "Dhar Mann": "Short-video mogul packaging simple moral lessons for algorithmic attention spans.",
  "Charli D'Amelio": "TikTok dance prodigy who converted viral choreography into a family brand.",
  "Khaby Lame": "Silent-comedy minimalist proving universal frustration can scale without dialogue.",
  ...
  "Shohei Ohtani": "Baseball's rare two-way force, redefining what one roster spot can do.",
  "Caitlin Clark": "A long-range catalyst turning women's basketball attention into appointment viewing.",
  "Albert Einstein": "Reframed space, time, and certainty with equations still shaping physics.",
  "Marie Curie": "Turned radioactivity into modern science, paying a severe personal price.",
  "Charles Darwin": "Made life history intelligible, and human exceptionalism harder to defend.",
  "Nikola Tesla": "A visionary inventor whose electrical ideas outlived his business failures.",
  "Stephen Hawking": "Made black holes public culture without simplifying the cosmic stakes.",
  "Richard Feynman": "Explained nature with mischief, rigor, and an allergy to pretense.",
  "Carl Sagan": "Made the cosmos feel vast, knowable, and ethically urgent.",
  "Yuval Noah Harari": "Turns sweeping history into sharp frameworks for anxious modern minds.",
  "George Orwell": "Mapped power's language games before propaganda became ambient weather.",
  "Martin Luther King Jr.": "Fused moral clarity with strategy against America's democratic contradictions.",
  "Mahatma Gandhi": "Turned disciplined nonviolence into a mass challenge to empire.",
  "Malcolm X": "Gave Black self-determination a fierce, evolving public voice.",
  "Nelson Mandela": "Transformed imprisonment into political leverage for a fractured nation's future."
};
